        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="message-box">
                    <h1 class="m-b-0">Hmm...</h1>
                    @if (Session::has('notfound'))
                        <p>{{ Session::get('notfound') }} </p>
                        {{ Session::forget('notfound') }}
                    @elseif (Session::has('optout'))
                        <p>{{ Session::get('optout') }} </p>
                        {{ Session::forget('optout') }}
                    @else
                        <p>Page not found</p>
                    @endif
                    <div class="buttons-con">
                        <div class="action-link-wrap">
                            ...
                            <a href="{{ route('home') }}" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Go to home</a>
                        </div>
                    </div>
                </div>
            </div>
