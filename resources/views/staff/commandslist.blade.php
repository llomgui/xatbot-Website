                ...
                <table class="table m-0">
                    ...
                    <tbody>
                    	...
                    	<tr>
                            ...
                            <td>TODO : SHOW THE RIGHT MINRANK !!</td>
                            <td>
                                <button class="btn btn-icon btn-xs waves-effect waves-light btn-warning m-b-5 edit_button" data-command_id="{{ $command->id }}" data-name="{{ $command->name }}" data-description="{{ $command->description }}" data-minrank="{{ $command->default_level }}" data-target="#edit-command-modal" data-toggle="modal"> <i class="fa fa-wrench"></i> </button>
