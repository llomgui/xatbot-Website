...
Route::group(['prefix' => 'panel'], function () {
    ...
    Route::group(['prefix' => 'bot', 'middleware' => 'auth'], function () {
        ...
        Route::get('autotemp', 'Bot\AutoTempController@showAutoTempForm')->name('bot.autotemp');
        Route::post('createautotemp', 'Bot\AutoTempController@createAutoTemp')->name('bot.createautotemp');
